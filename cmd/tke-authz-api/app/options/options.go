...
func NewOptions(serverName string) *Options {
	return &Options{
		Log:               log.NewOptions(),
		SecureServing:     apiserveroptions.NewSecureServingOptions(serverName, 9466),
		Debug:             apiserveroptions.NewDebugOptions(),
		ETCD:              storageoptions.NewETCDStorageOptions("/tke/authz"),
...
// Should be called after tke-authz-api flags parsed.
