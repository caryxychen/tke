...
// List lists all ClusterPolicyBindings in the indexer for a given namespace.
func (s clusterPolicyBindingNamespaceLister) List(selector labels.Selector) (ret []*v1.ClusterPolicyBinding, err error) {
...
// Get retrieves the ClusterPolicyBinding from the indexer for a given namespace and name.
func (s clusterPolicyBindingNamespaceLister) Get(name string) (*v1.ClusterPolicyBinding, error) {
