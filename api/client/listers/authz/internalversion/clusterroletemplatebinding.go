...
type ClusterRoleTemplateBindingLister interface {
	...
	List(selector labels.Selector) (ret []*authz.ClusterRoleTemplateBinding, err error)
...
// List lists all ClusterRoleTemplateBindings in the indexer.
func (s *clusterRoleTemplateBindingLister) List(selector labels.Selector) (ret []*authz.ClusterRoleTemplateBinding, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*authz.ClusterRoleTemplateBinding))
	})
	return ret, err
}
...
type ClusterRoleTemplateBindingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*authz.ClusterRoleTemplateBinding, error)
...
// List lists all ClusterRoleTemplateBindings in the indexer for a given namespace.
func (s clusterRoleTemplateBindingNamespaceLister) List(selector labels.Selector) (ret []*authz.ClusterRoleTemplateBinding, err error) {
...
// Get retrieves the ClusterRoleTemplateBinding from the indexer for a given namespace and name.
func (s clusterRoleTemplateBindingNamespaceLister) Get(name string) (*authz.ClusterRoleTemplateBinding, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(authz.Resource("clusterroletemplatebinding"), name)
	}
	return obj.(*authz.ClusterRoleTemplateBinding), nil
}
